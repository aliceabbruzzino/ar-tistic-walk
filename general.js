...
function changeImage() {
    if (image.getAttribute('src') == "./icons/begin_phone.svg") {
        ...
        document.getElementById("caption").innerHTML="<h3>Viewing</h3><p>Once you've reached the near location, <br> open the view page</p>";
    } else if (image.getAttribute('src') == "./icons/begin_eye.svg") {
        image.src = "./icons/begin_rocket.svg";
        document.getElementById("caption").innerHTML="<h3>Departure</h3><p>You are now ready to begin your journey</p>";
    } else {
